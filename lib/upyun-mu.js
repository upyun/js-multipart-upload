...
'use strict';
    ...
    function upload(path, fileObject) {
        var self = this;
        ...
        async.waterfall([
            ...
            function(callback) {
                ...
                } else if (Object.prototype.toString.call(fileObject) === '[object File]') {
                    file = fileObject;
                } else {
                    files = document.querySelector(fileObject).files;
                }
            ...
            function(chunkInfo, res, callback) {
                ...
                if (fileObject === void 0) {
                    ...
                    file = document.querySelector(fileObject).files[0];
                }
